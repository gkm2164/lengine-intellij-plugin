...
public class LengineDefStmtImpl extends ASTWrapperPsiElement implements LengineDefStmt {

  public LengineDefStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public LengineDefSymbol getDefSymbol() {
    return findNotNullChildByClass(LengineDefSymbol.class);
  }
