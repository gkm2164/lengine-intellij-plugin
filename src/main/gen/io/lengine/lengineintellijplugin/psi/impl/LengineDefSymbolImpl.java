...
public class LengineDefSymbolImpl extends ASTWrapperPsiElement implements LengineDefSymbol {

  public LengineDefSymbolImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LengineVisitor visitor) {
    visitor.visitDefSymbol(this);
  }
