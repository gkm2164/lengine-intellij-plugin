...
public class LengineExportSymbolImpl extends ASTWrapperPsiElement implements LengineExportSymbol {

  public LengineExportSymbolImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LengineVisitor visitor) {
    visitor.visitExportSymbol(this);
  }
