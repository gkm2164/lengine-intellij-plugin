...
public class LengineForWhenStmtImpl extends ASTWrapperPsiElement implements LengineForWhenStmt {

  public LengineForWhenStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LengineVisitor visitor) {
    visitor.visitForWhenStmt(this);
  }
