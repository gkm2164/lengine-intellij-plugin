...
public class LengineLambdaStmtImpl extends ASTWrapperPsiElement implements LengineLambdaStmt {

  public LengineLambdaStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LengineVisitor visitor) {
    visitor.visitLambdaStmt(this);
  }
