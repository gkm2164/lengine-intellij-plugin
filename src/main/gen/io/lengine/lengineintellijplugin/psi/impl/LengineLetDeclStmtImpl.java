...
public class LengineLetDeclStmtImpl extends ASTWrapperPsiElement implements LengineLetDeclStmt {

  public LengineLetDeclStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LengineVisitor visitor) {
    visitor.visitLetDeclStmt(this);
  }
