...
public class LengineLetStmtImpl extends ASTWrapperPsiElement implements LengineLetStmt {

  public LengineLetStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<LengineLetDeclStmt> getLetDeclStmtList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LengineLetDeclStmt.class);
  }
