...
public class LengineLoopStmtImpl extends ASTWrapperPsiElement implements LengineLoopStmt {

  public LengineLoopStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<LengineForStmt> getForStmtList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LengineForStmt.class);
  }
