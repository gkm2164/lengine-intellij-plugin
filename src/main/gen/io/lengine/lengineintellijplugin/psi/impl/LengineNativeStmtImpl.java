...
public class LengineNativeStmtImpl extends ASTWrapperPsiElement implements LengineNativeStmt {

  public LengineNativeStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LengineVisitor visitor) {
    visitor.visitNativeStmt(this);
  }
  ...
  @Override
  @NotNull
  public LengineType getType() {
    return findNotNullChildByClass(LengineType.class);
  }
