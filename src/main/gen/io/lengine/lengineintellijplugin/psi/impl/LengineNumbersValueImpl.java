...
public class LengineNumbersValueImpl extends ASTWrapperPsiElement implements LengineNumbersValue {

  public LengineNumbersValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LengineVisitor visitor) {
    visitor.visitNumbersValue(this);
  }
