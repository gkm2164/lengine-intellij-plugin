...
public class LengineObjectValueEntryImpl extends ASTWrapperPsiElement implements LengineObjectValueEntry {

  public LengineObjectValueEntryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LengineVisitor visitor) {
    visitor.visitObjectValueEntry(this);
  }
