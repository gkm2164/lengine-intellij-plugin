...
public class LengineObjectValueImpl extends ASTWrapperPsiElement implements LengineObjectValue {

  public LengineObjectValueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<LengineObjectValueEntry> getObjectValueEntryList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LengineObjectValueEntry.class);
  }
