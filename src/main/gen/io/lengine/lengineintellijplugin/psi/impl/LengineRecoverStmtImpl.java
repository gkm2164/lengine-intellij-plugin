...
public class LengineRecoverStmtImpl extends ASTWrapperPsiElement implements LengineRecoverStmt {

  public LengineRecoverStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LengineVisitor visitor) {
    visitor.visitRecoverStmt(this);
  }
