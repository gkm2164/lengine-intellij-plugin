...
public class LengineTryStmtImpl extends ASTWrapperPsiElement implements LengineTryStmt {

  public LengineTryStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public LengineRecoverStmt getRecoverStmt() {
    return findNotNullChildByClass(LengineRecoverStmt.class);
  }
